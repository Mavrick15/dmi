          ...
          <div key={endpoint.id} className="p-5 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-3">
              <div className="flex items-center gap-3">
                ...
                <code className="text-sm font-mono text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-slate-950 px-2 py-1 rounded border border-white/20 dark:border-white/10">
                  {endpoint.path}
                </code>
              </div>
