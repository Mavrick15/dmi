    ...
    const getRoleBadge = (role) => {
        switch (role) {
            ...
            case 'docteur_clinique':
                return <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-bold bg-sky-100 text-sky-700 dark:bg-sky-900/30 dark:text-sky-300"><Icon name="Stethoscope" size={10} /> Médecine générale</span>;
            case 'docteur_labo':
                return <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-xs font-bold bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-300"><Icon name="TestTube" size={10} /> Médecin biologiste</span>;
            case 'infirmiere':
