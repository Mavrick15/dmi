...
const DocumentVersionsModal = ({ document, isOpen, onClose }) => {
  ...
  return (
    <AnimatedModal isOpen={isOpen} onClose={onClose}>
      <div className="glass-panel rounded-xl shadow-xl w-full max-w-2xl max-h-[85vh] flex flex-col overflow-hidden">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto p-6 min-h-0">
          {isLoading ? (
            ...
            <div className="space-y-3">
              {/* Version actuelle */}
              <div className="rounded-xl glass-panel p-4 border-l-4 border-l-primary">
                ...
                <>
                  ...
                  {versionsList.map((version) => {
                    ...
                    return (
                      <div
                        key={version.id}
                        className="rounded-xl glass-surface p-4 hover:shadow-md transition-shadow"
                      >
