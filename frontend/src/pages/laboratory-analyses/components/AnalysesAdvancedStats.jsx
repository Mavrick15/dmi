  ...
  if (!advancedStats) {
    return (
      <motion.div 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl md:rounded-3xl p-8 md:p-12 text-center"
      >
        <motion.div
          animate={{ 
            scale: [1, 1.1, 1],
    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        <motion.div
          ...
          className="bg-gradient-to-br from-indigo-50 to-indigo-100 dark:from-indigo-900/20 dark:to-indigo-900/10 rounded-xl md:rounded-2xl p-3 md:p-4 border border-indigo-200 dark:border-indigo-800 shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
        >
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/10 rounded-xl md:rounded-2xl p-3 md:p-4 border border-blue-200 dark:border-blue-800 shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
        >
          <div className="flex items-center gap-2 mb-1 md:mb-2">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-900/10 rounded-xl md:rounded-2xl p-3 md:p-4 border border-emerald-200 dark:border-emerald-800 shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
        >
          <div className="flex items-center gap-2 mb-1 md:mb-2">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-900/10 rounded-xl md:rounded-2xl p-3 md:p-4 border border-amber-200 dark:border-amber-800 shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
        >
          <div className="flex items-center gap-2 mb-1 md:mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <motion.div
          ...
          className="bg-white dark:bg-slate-900 border border-slate-200/50 dark:border-slate-800/50 rounded-2xl md:rounded-3xl p-4 md:p-6 shadow-lg hover:shadow-2xl transition-shadow"
        >
          <h4 className="text-sm md:text-base font-bold text-slate-700 dark:text-slate-300 mb-3 md:mb-4 flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-br from-primary/20 to-blue-500/20 rounded-lg flex items-center justify-center">
        ...
        {prioriteData.length > 0 && (
          ...
          >
            <h4 className="text-sm md:text-base font-bold text-slate-700 dark:text-slate-300 mb-3 md:mb-4 flex items-center gap-2">
              <div className="w-8 h-8 bg-gradient-to-br from-amber-500/20 to-red-500/20 rounded-lg flex items-center justify-center">
