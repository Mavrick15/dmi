...
const PerformanceIndicator = ({ 
  ...
  return (
    <div className={`bg-white dark:bg-slate-900 rounded-3xl border border-slate-100 dark:border-slate-800 p-6 shadow-sm hover:shadow-md transition-all duration-300 ${className}`}>
      ...
      <div className="grid grid-cols-3 gap-2 pt-5 mt-5 border-t border-slate-100 dark:border-slate-800">
